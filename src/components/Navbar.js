            ...
            <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div class="flex space-x-4">
                    ...
                    <a 
                        ...
                        class="bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium hover:cursor-pointer" aria-current="page">Dashboard
                    </a>

                    <a
                        onClick={() => navigate('/team')}
                        class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium hover:cursor-pointer">Team
                    </a>

                    <a
                        onClick={() => navigate('/calendar')}
                        class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium hover:cursor-pointer">Calendar</a>

                    <a
                        onClick={() => navigate('/manage')}
                        class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium hover:cursor-pointer">Manage</a>
                </div>
                </div>
            </div>
            <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <div class="ml-3 relative">
                    <div className='flex justify-center items-center gap-2'>
                        ...
                        <img referrerPolicy="no-referrer" class="h-8 w-8 rounded-full" src={user?.photoURL} alt="" />
                        </button>
                    </div>
                    ...
                    { showProfileMenu &&
                        <div class={`origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none ${menuAnimation}`} role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                            ...
                            <a onClick={() => navigate('/profile')} class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:cursor-pointer" role="menuitem" tabindex="-1" id="user-menu-item-0">Your Profile</a>
